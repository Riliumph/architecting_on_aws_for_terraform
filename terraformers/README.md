...
> `$TF_BACKEND_BUCKET`はdockerfileで定義済み。  
> ただし、S3のリソース名は世界共有なのでオリジナルに変えること。
...
aws_iam_policy.terraformer_policy: Creation complete after 1s [id=arn:aws:iam::${your-account-id}:policy/TerraformerPolicy]
